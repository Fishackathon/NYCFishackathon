            ...
            if (dr == System.Windows.Forms.DialogResult.OK)
            {
                ...
                foreach (String arquivo in ofd1.FileNames)
                {
                    ...
                    try
                    {
                        ...
                        if (binario)
                        {
                            label3.Text = "Binary: YES";
                        }
                        else
                            label3.Text = "Binary: NO";
                        bool cinza = dado.Type == imageType.Gray;//dado.verificaGray();
                        if (cinza)
                        {
                            label4.Text = "Grayscale: YES";
                        }
                        else
                            label4.Text = "Grayscale: NO";
                        int h, l;
                        h = dado.getAltura();
                        l = dado.getLargura();
                        label6.Text = "Size: " + h + "x" + l;
                        ...
                        label8.Text = "Amount of black pixels: " + Math.Round(Estatistica.PorcentagemPretos(dado),3).ToString() + "%";

                        label7.Text = "File size: " + tamanhoarq + extTamanho;
 ...
 */
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            sfd.Title = "Specify the file and the folder to save the image:";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            label8.Text = "Amount of black: " + Math.Round(Estatistica.PorcentagemPretos(pct), 3).ToString() + "%";
            switch (opcaoProc)
            {
                case "Dilate (BW)":
