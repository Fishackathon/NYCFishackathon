...
namespace IniciacaoCientifica
{
    public partial class teste : Form
    {
        ...
        {
            InitializeComponent();
            Image imagem = Image.FromFile("D:/Arquivos/Imagens Teste Morfologia/timpar.png");
            ...
            //Morfologia.BordaExterna(im1);
            //imagem1 = (ImageData)im1.Clone();
            Esqueleto.Processa(imagem1);
            Bitmap final1 = imagem1.getBitmap();
            final1.Save("D:/Arquivos/Imagens Teste Morfologia/export.bmp");
